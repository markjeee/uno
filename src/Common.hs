...
getCardsByColor :: Color -> Hand -> [ Card ]
getCardsByColor col hand = [ c | c <- hand, (color c) == col ]

countCardsByColor :: Color -> Hand -> Int
countCardsByColor col hand = length $ [ c | c <- hand, (color c) == col ]

getCardsByValue :: Value -> Hand -> [ Card ]
getCardsByValue val hand = [ c | c <- hand, (value c) == val ]

countCardsByValue :: Value -> Hand -> Int
countCardsByValue val hand = length $ [ c | c <- hand, (value c) == val ]
...
getCardWithColor :: Color -> Hand -> Card
getCardWithColor col hand = fromMaybe noCard $ find (\c -> (color c) == col) hand

valueInHand :: Value -> Hand -> Bool
valueInHand val hand = any (\c -> (value c) == val) hand

getCardWithValue :: Value -> Hand -> Card
getCardWithValue val hand = fromMaybe noCard $ find (\c -> (value c) == val) hand

wildcardInHand :: Hand -> Bool
wildcardInHand hand = any (\c -> isWildcard c) hand

getWildcard :: Hand -> Card
getWildcard hand = fromMaybe noCard $ find (\c -> isWildcard c) hand
